...
final class ConfigFabricPayloadRegistry {
	...
	static void register() {
		PayloadTypeRegistry.clientboundPlay().register(IdentityPacket.TYPE, IdentityPacket.STREAM_CODEC);
		PayloadTypeRegistry.clientboundPlay().register(SyncPacket.TYPE, SyncPacket.STREAM_CODEC);
	}
}
