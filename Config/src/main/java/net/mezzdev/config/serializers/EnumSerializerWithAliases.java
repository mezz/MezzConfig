...
/**
 * Enum serializer that accepts additional legacy names while deserializing.
 */
public final class EnumSerializerWithAliases<T extends Enum<T>> extends EnumSerializer<T> {
	private final Map<String, T> aliases;

	/**
	 * Create an enum serializer with aliases mapped to enum values.
	 */
